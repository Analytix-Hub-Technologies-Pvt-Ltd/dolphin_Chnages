            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-border-theme bg-bg-header/50 text-xs font-semibold text-text-secondary">
                  <th className="py-3 px-4 w-28">Feedback ID</th>
                  <th className="py-3 px-4 min-w-[260px]">Question</th>
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      ...
                      {row.feedback_comment && (
                        <div className="text-[11px] text-text-secondary italic line-clamp-1 mt-0.5">
                          "{row.feedback_comment}"
                        </div>
                      )}
                    </td>
