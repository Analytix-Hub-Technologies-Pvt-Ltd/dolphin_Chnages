# Database Baseline Schema: `dolphindb`
...
|---|---|---|---|
| 1 | [`users`](#1-users) | 19 | User accounts, authentication credentials, and profile settings |
| 2 | [`chat_sessions`](#2-chat_sessions) | 8 | Tracks active chat sessions for users |
| 3 | [`course_content`](#3-course_content) | 9 | Extracted sections, topics, lessons, and content for courses |
| 4 | [`course_content_backup`](#4-course_content_backup) | 9 | Backup snapshot of course content table |
| 5 | [`master_course_data`](#5-master_course_data) | 4 | Master registry of available courses and course metadata |
| 6 | [`master_course_data_backup`](#6-master_course_data_backup) | 4 | Backup snapshot of master course data table |
| 7 | [`message_feedback`](#7-message_feedback) | 11 | User ratings and feedback on AI responses |
...
| 10 | [`tutor_content`](#10-tutor_content) | 7 | Primary source content indexed into FAISS vector store |
| 11 | [`user_memories`](#11-user_memories) | 4 | Long-term extracted user preferences, facts, and context |
